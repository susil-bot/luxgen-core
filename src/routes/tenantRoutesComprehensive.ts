/**
 * @fileoverview Comprehensive Tenant Routes
 * Complete tenant routes system with workflow support
 * 
 * @module
 */

import RoutesBuilder from './core/RoutesBuilder';
import { PageWorkflow, PluginWorkflow, ProxyWorkflow, CollectionWorkflowMediator, MetaWorkflow } from './core/Workflow';
import { WorkflowFn } from './core/RoutesBuilder';
 ...
 */
export class TenantRoutesComprehensive {
...
export default TenantRoutesComprehensive;
