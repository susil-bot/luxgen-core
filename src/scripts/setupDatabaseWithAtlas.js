...
/**
 * Database Setup Script with MongoDB Atlas
 * 
 * This script sets up the database using MongoDB Atlas cloud connection
 * Following LuxGen rules: Multi-tenant architecture, max 5 records per model
 * 
 * Usage: node src/scripts/setupDatabaseWithAtlas.js
 */
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://username:password@cluster.mongodb.net/luxgen?retryWrites=true&w=majority';
 ...
 * Main setup function
 */
async function setupDatabaseWithAtlas() {
  try {
    console.log('🚀 LuxGen Database Setup with MongoDB Atlas');
    console.log('==========================================');
...
module.exports = { setupDatabaseWithAtlas };
